 ...
 */
class filter_widget extends moodle_text_filter {
    /**
    ...
    function filter($text, array $options = array()) {
        ...
        $def_config = get_config('filter_widget');
        ...
        $renderer = $PAGE->get_renderer('filter_widget');
        ...
        $text = filter_widget_insert_content($text, $starttag, $endtag, $courseid, $renderer);
        return $text;
    }
}
/**
 ...
 */
function filter_widget_insert_content($str, $starttag, $endtag, $courseid, $renderer) {
