...
/**
 * Custom renderer class for filter_widget
 * @copyright  2017 Richard Jones (https://richardnz.net/)
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class filter_widget_renderer extends plugin_renderer_base {
    /**
    ...
    public function get_content($content) {
        $this->page->requires->js_call_amd('filter_widget/show_content', 
                'init', array($content));
        $button = html_writer::tag('button', 
                get_string('button_label','filter_widget'));
        return html_writer::div($button,'filter_widget_content');
    }
}